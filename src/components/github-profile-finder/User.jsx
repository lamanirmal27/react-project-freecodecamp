  ...
  return (
    <div className="whole-container">
      ...
      <div className="information">
        ...
        <a href={html_url} target="_">Visit Github Profile</a>
      </div>
    </div>
  );
}
